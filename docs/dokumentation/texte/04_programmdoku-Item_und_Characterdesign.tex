...
Der letzte Teil benutzt eine Folge if-else-Abfragen, um den Lehrern im Kampf ihre Items zuzuweisen. Diese fragen zuerst nach der Fachschaft des Lehrers/der Lehrerin und stellen diesen dann einen Pool von Items bereit, welche sie dann im Kampf verwenden können.
\\
\begin{lstlisting}
