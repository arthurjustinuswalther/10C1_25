...
\begin{itemize}
    \item Fachschaft Biologie
        \begin{itemize}
        \item Das Minigame der Fachschaft Biologie ähnelt in seine Grundzügen dem Pflanzentestat am Carl-Zeiss-Gymansium Jena. Die Pflanzen wurden durch Bilder von WikiCommons (Creative Commons Licenses) dargestellt und in Java implementiert.
        \end{itemize}
